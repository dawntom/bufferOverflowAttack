...
2.) Using the xxd utility, craft a string with ASCII value of 1's and feed it into the buffer by pipling the stream to stdin to the scanf call. Will this cause an error?
